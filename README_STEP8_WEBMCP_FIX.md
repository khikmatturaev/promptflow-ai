...
The latest build contained the full 12-tool registry, but the browser Inspector could show zero tools. The registration lifecycle was too dependent on the React effect timing and could return early when `document.modelContext` was not ready at mount time.
